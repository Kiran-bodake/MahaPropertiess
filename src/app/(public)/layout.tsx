...
export const metadata: Metadata = {
  ...
  description: "Verified property listings in Maharashtra including NA plots, agriculture land, commercial and residential properties.",
  openGraph: {
    ...
    images: [{ url: "/maha.png", width: 1200, height: 630, alt: "MahaProperties" }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
